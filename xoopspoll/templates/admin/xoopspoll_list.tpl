...
<{foreach item=pollItem from=$pollItems }>
    <tr class='<{cycle values="odd,even"}>'>
      ...
      <td>
        <input type='text' name='weight[<{$pollItem.id}>]' value='<{$pollItem.weight}>' size='6' maxlength='5' />
      </td>
...
<{*      <td><{$pollItem.question}></td> *}>
      ...
      <td class='center'>
<{      html_image file=$pollItem.buttons.edit.file href=$pollItem.buttons.edit.href alt=$pollItem.buttons.edit.alt title=$pollItem.buttons.edit.alt}>
<{      html_image file=$pollItem.buttons.clone.file href=$pollItem.buttons.clone.href alt=$pollItem.buttons.clone.alt title=$pollItem.buttons.clone.alt}>
<{      html_image file=$pollItem.buttons.delete.file href=$pollItem.buttons.delete.href alt=$pollItem.buttons.delete.alt title=$pollItem.buttons.delete.alt}>
<{      html_image file=$pollItem.buttons.log.file href=$pollItem.buttons.log.href alt=$pollItem.buttons.log.alt title=$pollItem.buttons.log.alt}>
<{*

...
if (!empty($GLOBALS['xoopsModuleConfig']['quickreply_enabled']) && $topic_handler->getPermission($forum_obj, $topic_obj->getVar('topic_status'), 'reply') && !$moderate_handler->verifyUser(-1, '', $forum_obj->getVar('forum_id'))) {

...
<div class="pad5">
    ...
    <a id="threadtop"></a><{$down}><a href="#threadbottom"><{$smarty.const._MD_BOTTOM}></a>&nbsp;&nbsp;<{$previous}>
        &nbsp;<a
...
<{foreach item=topic_post from=$topic_posts}>
    ...
    <br>
    <{foreachelse}>
    <div style="text-align:center;width:100%;text-align:center;font-size:1.5em;padding:5px;"><{$smarty.const._MD_ERRORPOST}></div>
<{/foreach}>
